...
namespace Kevins.Examples.Common.Utils
{
    public class ProcessStarter : IDisposable
    {
        ...
        public void Run()
        {
            ...
            CreateProcessAsUser(primaryToken, null, command, ref Security1, ref Security2, false, CREATE_NO_WINDOW | NORMAL_PRIORITY_CLASS | CREATE_UNICODE_ENVIRONMENT, lpEnvironment, null, ref StartupInfo, out processInfo);
